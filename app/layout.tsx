        ...
        <nav className="sticky top-0 z-40 backdrop-blur-md bg-white/70 dark:bg-[#161617]/70 border-b border-[#e8e8ed] dark:border-neutral-900 px-8 py-3 flex items-center justify-between transition-colors duration-300">
          <div className="flex items-center gap-8">
            ...
            <div className="flex items-center gap-6">
              <a
                href="/"
                className={`apple-dock-indicator apple-nav-border apple-zoom-indicator apple-tab-slide apple-indicator-sweep ${pathname === '/' ? 'active text-[#1d1d1f] dark:text-[#f5f5f7]' : 'text-neutral-500 hover:text-[#1d1d1f] dark:text-neutral-400 dark:hover:text-neutral-200'} text-xs font-medium transition-colors`}
              >
                Dashboard
              </a>
              <a
                href="/sent"
                className={`apple-dock-indicator apple-nav-border apple-zoom-indicator apple-tab-slide apple-indicator-sweep ${pathname === '/sent' ? 'active text-[#1d1d1f] dark:text-[#f5f5f7]' : 'text-neutral-500 hover:text-[#1d1d1f] dark:text-neutral-400 dark:hover:text-neutral-200'} text-xs font-medium transition-colors`}
              >
                Sent
              </a>
              <a
                href="/analytics"
                className={`apple-dock-indicator apple-nav-border apple-zoom-indicator apple-tab-slide apple-indicator-sweep ${pathname === '/analytics' ? 'active text-[#1d1d1f] dark:text-[#f5f5f7]' : 'text-neutral-500 hover:text-[#1d1d1f] dark:text-neutral-400 dark:hover:text-neutral-200'} text-xs font-medium transition-colors`}
              >
                Analytics
              </a>
              <a
                href="/settings"
                className={`apple-dock-indicator apple-nav-border apple-zoom-indicator apple-tab-slide apple-indicator-sweep ${pathname === '/settings' ? 'active text-[#1d1d1f] dark:text-[#f5f5f7]' : 'text-neutral-500 hover:text-[#1d1d1f] dark:text-neutral-400 dark:hover:text-neutral-200'} text-xs font-medium transition-colors`}
              >
                Settings
              </a>
            </div>
