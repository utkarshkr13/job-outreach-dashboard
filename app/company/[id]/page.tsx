    ...
    <div className="max-w-3xl mx-auto space-y-6 pb-20">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 pt-1">
          ...
          <div className="flex items-center gap-2 w-full md:w-auto self-center">
            ...
            <label 
              ...
              className="flex-1 md:flex-none text-center bg-[#f5f5f7] hover:bg-[#e8e8ed] dark:bg-neutral-900 dark:hover:bg-neutral-800 text-neutral-700 dark:text-neutral-200 px-4 py-2.5 rounded-2xl text-[11px] font-bold border border-neutral-200 dark:border-neutral-850 cursor-pointer select-none block transition-colors active:scale-[0.97]"
            >
            ...
            {resumeStatus === 'custom' && (
              <button 
                ...
                disabled={uploadingResume}
                className="bg-red-50 hover:bg-red-100 dark:bg-red-950/20 dark:hover:bg-red-950/30 text-red-600 dark:text-red-400 border border-red-150 dark:border-red-950/40 px-3.5 py-2.5 rounded-2xl text-[11px] font-bold cursor-pointer transition-colors"
              >
                Delete Custom
              </button>
            )}
      ...
      <div className="bg-white dark:bg-[#161617] border border-[#e8e8ed] dark:border-neutral-900 rounded-3xl p-6 shadow-sm shadow-[rgba(0,0,0,0.01)] space-y-3">
        <div
          ...
          className="w-full flex justify-between items-center font-bold text-xs text-neutral-700 dark:text-neutral-250 cursor-pointer select-none transition-transform active:scale-[0.99]"
        >
        ...
        {!jdCollapsed && (
          <div className="space-y-3 pt-1.5 border-t border-[#e8e8ed] dark:border-neutral-900 transition-colors duration-200">
            <div className="flex gap-2">
              ...
              <button
                ...
                disabled={jdLoading}
                className="bg-[#0071e3] hover:bg-[#0077ed] text-white rounded-2xl px-4 py-2 text-xs font-bold transition-colors disabled:opacity-50"
              >
      ...
      <div className="bg-white dark:bg-[#161617] border border-[#e8e8ed] dark:border-neutral-900 rounded-3xl p-6 shadow-sm shadow-[rgba(0,0,0,0.01)] space-y-3">
        ...
        <input
          ...
          className="w-full bg-[#f5f5f7] dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-2xl px-4 py-3 text-xs text-[#1d1d1f] dark:text-[#f5f5f7] focus:outline-none focus:border-[#0071e3] transition-colors font-medium"
      ...
      <div className="bg-white dark:bg-[#161617] border border-[#e8e8ed] dark:border-neutral-900 rounded-3xl p-6 shadow-sm shadow-[rgba(0,0,0,0.01)] space-y-3">
        ...
        <textarea
          ...
          rows={12}
          className="w-full bg-[#f5f5f7] dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-850 rounded-3xl px-4 py-4 text-xs text-[#1d1d1f] dark:text-[#f5f5f7] focus:outline-none focus:border-[#0071e3] transition-colors font-mono leading-relaxed resize-none"
        />
      </div>
        ...
        {company.emailStatus === 'Approved' ? (
          <div className="flex-1 relative flex items-center">
            <button
              ...
              disabled={sending}
              className="flex-1 bg-[#0071e3] hover:bg-[#0077ed] text-white py-3 rounded-l-2xl font-bold text-xs shadow-sm hover:shadow-md transition-colors cursor-pointer flex items-center justify-center gap-2 select-none"
            >
              {sending ? 'Sending...' : '🚀 Approve & Deliver Pitch'}
            </button>
            <button
              onClick={() => setDrawerSendMenuOpen(!drawerSendMenuOpen)}
              className="bg-[#0061c3] hover:bg-[#0057b3] text-white py-3 px-3.5 rounded-r-2xl border-l border-white/20 transition-colors font-bold text-xs cursor-pointer select-none"
            >
              ▼
            </button>
            {drawerSendMenuOpen && (
          ...
          <button
            onClick={handleApproveAndSend}
            disabled={sending}
            className="flex-1 bg-[#0071e3] hover:bg-[#0077ed] text-white py-3 rounded-2xl font-bold text-xs shadow-sm hover:shadow-md transition-colors cursor-pointer flex items-center justify-center gap-2 select-none"
          >
            {sending ? (
